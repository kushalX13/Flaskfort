...
Secure Notes API (JWT) shipped like a real product: tests, CI, Docker, and security gates.
...
- Home: `http://127.0.0.1:5000/` (local) or `http://127.0.0.1:8000/` (Docker)
- Login/Register: `/login`
- Notes UI: `/notes-ui`
- Swagger: `/docs`
- Dev DB snapshot: `/dev/db` (dev only)
...
This enables `/ai/assist` and the LLM panel in the Notes UI without external billing.
...
Secure Notes API (JWT) + tests + CI + security gates (coming next).
